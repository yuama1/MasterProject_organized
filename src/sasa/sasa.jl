...
The solvent-accessible surface area (SASA) or accessible surface area (ASA) type.
It has two fields: "area" and "atoms".
"area" shows the total solvent-accessible surface area.
"atoms" is a DataFrame shows the solvent-accessible surface area of each atom in the system.

"""

struct SASA
        area::T where T <: Number
...
function get_neighbours(atoms::DataFrame, number1::Int64, r1::SVector, radius1::Float64, hash_id::SVector, probe_radius::Float64)
        ...
        neighbours.neighbour = [is_overlap(number1,r.number, r1, r.r, radius1, r.radii, probe_radius) for r in eachrow(neighbours)]
...
"""
        sasa(atoms::DataFrame, num_points::Int64=92, probe_radius::Float64=1.4)

Calculate the solvent accessible surface area of a set of atoms in DataFrame format, solvent and ligands included.
It returns a SASA object with two fields, "area" and "atoms".

"area" shows the total solvent-accessible surface area.
"atoms" is a DataFrame shows the solvent-accessible surface area of each atom in the system.

"""
function sasa(atoms::DataFrame, num_points::Int64=92, probe_radius::Float64=1.4)
...
"""
        sasa(molecule::PDBMolecule, num_points::Int64=92, probe_radius::Float64=1.4)

Calculate the solvent accessible surface area of a PDBMolecule, solvent and ligands included.
It returns a SASA object with two fields, "area" and "atoms".
...
"""
sasa(molecule::PDBMolecule, num_points::Int64=92, probe_radius::Float64=1.4)  = sasa(molecule.atoms, num_points, probe_radius)
