...
"""
        residue_residue_pairs(atoms::DataFrame, a::String, b::String)
        
Calculate interface residue-residue pairs. Interface residue-residue pairs are defined as
residue pairs that belong to different biological units and have at least one pair of atoms, one in
each residue, lie within 5Å of the each other.
It returns a DataFrame of interface residue-residue pairs.
...
residue_residue_pairs(m::PDBMolecule, a::String, b::String) = residue_residue_pairs(m.atoms, a, b)
