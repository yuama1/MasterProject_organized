...
# This function uses another defination of interface atoms and interface residues
...
"""
        interface5A(atoms::DataFrame, a::String, b::String)

Calculate interface residues. Interface residues are defined as
residues with at least an atom within 5Å of the other biological unit.
It returns a DataFrame of interface residues.
